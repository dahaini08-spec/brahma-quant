...
CAPABILITY_CHECKS = {
    ...
    'OI四象限':         lambda r, rpt: '_oi_quadrant' in str(r) or 'LONG_CROWD' in rpt or 'OI四象' in rpt,
    'FVG磁铁':           lambda r, rpt: 'FVG' in rpt and '磁铁' in rpt,
    '止损池警告':        lambda r, rpt: '止损池' in rpt or 'liq_density' in str(r).lower(),
    '达摩院裁决':        lambda r, rpt: '达摩院' in rpt or 'dharma' in str(r).lower(),
    'NAV真实值':         lambda r, rpt: (r.get('nav_usdt') or r.get('nav') or 0) > 10,
