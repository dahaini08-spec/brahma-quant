...
def fast_evaluate(lib: dict, threshold: float,
    ...
    composite = (0.35 * min(sharpe, 5.0) +
                 0.30 * math.log(max(pf, 0.01)) +
                 0.20 * wr +
                 0.15 * oos_rate)
...
def save_v6_report(top_results: List[dict], lib_btc: dict, lib_eth: dict) -> str:
    out = {
        'framework':  'DharmaOptimizer v6.0',
