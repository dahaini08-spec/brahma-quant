...
def push_digest():
    ...
    try:
        ...
        thread_id = getattr(cfg, 'JARVIS_THREAD_ID', '019fd9dd-4b0f-71db-87fb-1e192ccb2291')
        to = f'{user_id}:t:{thread_id}' if user_id and thread_id else f'{user_id}:thread:019fd9dd-4b0f-71db-87fb-1e192ccb2291'
    except Exception:
        to = '73295708:thread:019fd9dd-4b0f-71db-87fb-1e192ccb2291'  # [BUG-3 修复] 外层异常时精确地址即SSOT
    import subprocess
