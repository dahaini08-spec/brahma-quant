...
try:
    ...
    PUSH_TARGET   = '73295708:t:019fd9dd-4b0f-71db-87fb-1e192ccb2291'  # SSOT v11 [线程更新 2026-07-08]
PUSH_CHANNEL  = 'jarvis'
    ...
    if issues:
        try:
            ...
            try:
                ...
                _tgt = '73295708:t:019fd9dd-4b0f-71db-87fb-1e192ccb2291'
                subprocess.run(
...
def check_cron_jobs() -> dict:
    ...
    try:
        ...
        CORRECT_THREAD = getattr(_sc2, 'JARVIS_THREAD_ID', '019fd9dd-4b0f-71db-87fb-1e192ccb2291')
    except Exception:
        CORRECT_THREAD  = '019fd9dd-4b0f-71db-87fb-1e192ccb2291'
    try:
        jobs_file = Path.home() / '.openclaw/cron/jobs.json'
        ...
        for name in KEY_SIGNAL_JOBS:
            ...
            _to_full = str(to)
            if CORRECT_THREAD not in _to_full:
...
def check_push_routing() -> dict:
    ...
    try:
        ...
        CORRECT_THREAD = getattr(_sc, 'JARVIS_THREAD_ID', '019fd9dd-4b0f-71db-87fb-1e192ccb2291')
    except Exception:
        CORRECT_THREAD = '019fd9dd-4b0f-71db-87fb-1e192ccb2291'
