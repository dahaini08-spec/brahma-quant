...
def push_digest():
    ...
    try:
        ...
        thread_id = getattr(cfg, 'JARVIS_THREAD_ID', '01a07628-0405-7e85-a34b-e68cd029dfc6')
        to = f'{user_id}:t:{thread_id}' if user_id and thread_id else f'{user_id}:thread:01a07628-0405-7e85-a34b-e68cd029dfc6'
    except Exception:
        to = '73295708:thread:01a07628-0405-7e85-a34b-e68cd029dfc6'  # [BUG-3 修复] 外层异常时精确地址即SSOT
    import subprocess
