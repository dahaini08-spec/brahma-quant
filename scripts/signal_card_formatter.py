...
def run():
    ...
    _sp.run(
        ['openclaw', 'message', 'send',
         '--channel', 'jarvis',
         '--target', os.environ.get('JARVIS_TARGET', __import__('scripts.system_config', fromlist=['JARVIS_TARGET']).JARVIS_TARGET if True else '73295708:t:019f8768-6731-777d-8924-2426a5abd10f'),
         '--message', card],
